...
def main(output_filepath="data/processed/flora_data_frame_full.csv"):
    ...
    fna = make_fna_data_frame(fna_filepath="data/external/fna_with_habitat.csv", frac_to_sample=1,
